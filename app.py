...
def weather():
    ...
    if request.method == "POST":
        ...
        if response.status_code == 200:
            ...
            return render_template("weather.html", filename = 'lightning.jpg', city='Please enter valid city name', current_temp= '',
            current_weather= '',hi_low= '', icon ='11d' )
        ...
        current_weather= current_weather,hi_low= hi_low, icon =icon, degree = degree )

    else: 
        return render_template("weather.html", filename = 'lightning.jpg', city='', current_temp= '',
        current_weather= '',hi_low= '', icon ='11d' )
